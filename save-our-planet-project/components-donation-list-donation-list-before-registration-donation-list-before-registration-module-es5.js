...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["components-donation-list-donation-list-before-registration-donation-list-before-registration-module"], {
  ...
  function srcAppComponentsDonationListDonationBeforeRegistrationDonationBeforeRegistrationComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var src_app_store_country_list_country_list_facade__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(
    ...
    var src_app_pipes_donation_list_format_donation_before_registration_tree_amount_pipe__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(
    /*! src/app/pipes/donation-list/format-donation-before-registration-tree-amount.pipe */
    ...
    function DonationBeforeRegistrationComponent_div_31_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function DonationBeforeRegistrationComponent_div_32_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div", 25);
    ...
    var DonationBeforeRegistrationComponent = /*#__PURE__*/function () {
      function DonationBeforeRegistrationComponent(_store$, _router, _facadeDonationListService, _facadeUserListService, _facadeCountryListService) {
      ...
      _createClass(DonationBeforeRegistrationComponent, [{
        ...
        key: "canMakeDonation",
        value: function canMakeDonation() {
    ...
    DonationBeforeRegistrationComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      template: function DonationBeforeRegistrationComponent_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function DonationBeforeRegistrationComponent_Template_button_click_33_listener() {
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](DonationBeforeRegistrationComponent, [{
        ...
        return [{
          ...
          type: src_app_store_country_list_country_list_facade__WEBPACK_IMPORTED_MODULE_9__["FacadeServiceCountryList"]
        }];
      }, {
        donation: [{
  ...
  function srcAppComponentsDonationListDonationListBeforeRegistrationDonationListBeforeRegistrationComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    DonationListBeforeRegistrationComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      styles: ["[_nghost-%COMP%] {\n  width: 100%;\n  min-height: 100vh;\n}\n\n.-app-donation-list[_ngcontent-%COMP%] {\n  position: relative;\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n  justify-content: flex-start;\n  width: 100%;\n  height: 100vh;\n  min-height: 100vh;\n  padding: 100px;\n  box-sizing: border-box;\n}\n\n.-app-donation-list[_ngcontent-%COMP%]::after {\n  content: \"\";\n  position: fixed;\n  top: 0;\n  left: 120px;\n  z-index: -9999;\n  width: 100%;\n  height: 100vh;\n  background-image: url('donation-list-bg.jpg');\n  background-size: cover;\n}\n\n.-app-donation-list__start[_ngcontent-%COMP%] {\n  display: flex;\n  flex-direction: column;\n  justify-content: center;\n  align-items: center;\n  width: 100%;\n  height: 100%;\n  color: white;\n}\n\n.-app-donation-list__start-title[_ngcontent-%COMP%] {\n  margin: 0;\n  text-transform: capitalize;\n  letter-spacing: 4px;\n  font-size: 32px;\n  font-weight: 600;\n}\n\n.-app-donation-list__start-sub-title[_ngcontent-%COMP%] {\n  margin: 0;\n  text-transform: uppercase;\n  letter-spacing: 3px;\n  font-size: 18px;\n}\n\n.-app-donation-list__start-title[_ngcontent-%COMP%], .-app-donation-list__start-sub-title[_ngcontent-%COMP%] {\n  margin: 20px;\n  -webkit-user-select: none;\n     -moz-user-select: none;\n      -ms-user-select: none;\n          user-select: none;\n  text-align: center;\n}\n\n.-app-donation-list__start-button[_ngcontent-%COMP%] {\n  width: 300px;\n  margin: 0px 50px;\n  margin-top: 20px;\n  padding: 25px 0px;\n  transition: 0.2s;\n  cursor: pointer;\n  outline: none;\n  border: 2px solid white;\n  border-radius: 45px;\n  background-color: rgba(8, 37, 8, 0.95);\n  color: white;\n  letter-spacing: 1px;\n  font-size: 20px;\n  font-weight: 600;\n}\n\n.-app-donation-list__start-button[_ngcontent-%COMP%]:hover {\n  -webkit-filter: brightness(1.4);\n          filter: brightness(1.4);\n}\n/*# sourceMappingURL=data:application/json;base64, */"]
    });
    /*@__PURE__*/
  ...
  function srcAppComponentsDonationListDonationListBeforeRegistrationDonationListBeforeRegistrationModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var src_app_pipes_donation_list_format_donation_before_registration_tree_amount_pipe__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    /*! src/app/pipes/donation-list/format-donation-before-registration-tree-amount.pipe */
    "./src/app/pipes/donation-list/format-donation-before-registration-tree-amount.pipe.ts");
    ...
    (function () {
      (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵsetNgModuleScope"](DonationListBeforeRegistrationModule, {
        declarations: [_donation_list_before_registration_component__WEBPACK_IMPORTED_MODULE_0__["DonationListBeforeRegistrationComponent"], _donation_before_registration_donation_before_registration_component__WEBPACK_IMPORTED_MODULE_1__["DonationBeforeRegistrationComponent"], src_app_pipes_donation_list_format_donation_before_registration_tree_amount_pipe__WEBPACK_IMPORTED_MODULE_5__["FormatDonationBeforeRegistrationTreeAmountPipe"]],
        imports: [_donation_list_before_registration_routing_module__WEBPACK_IMPORTED_MODULE_3__["DonationListBeforeRegistrationRoutingModule"], _angular_common__WEBPACK_IMPORTED_MODULE_4__["CommonModule"]]
      });
    })();
    /*@__PURE__*/
  ...
  /***/
  function srcAppPipesDonationListFormatDonationBeforeRegistrationTreeAmountPipeTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "FormatDonationBeforeRegistrationTreeAmountPipe", function () {
      return FormatDonationBeforeRegistrationTreeAmountPipe;
    });
    /* harmony import */
    ...
    var FormatDonationBeforeRegistrationTreeAmountPipe = /*#__PURE__*/function () {
      function FormatDonationBeforeRegistrationTreeAmountPipe() {
        _classCallCheck(this, FormatDonationBeforeRegistrationTreeAmountPipe);
      }

      _createClass(FormatDonationBeforeRegistrationTreeAmountPipe, [{
        key: "transform",
    ...
    FormatDonationBeforeRegistrationTreeAmountPipe.ɵfac = function FormatDonationBeforeRegistrationTreeAmountPipe_Factory(t) {
      return new (t || FormatDonationBeforeRegistrationTreeAmountPipe)();
    };

    FormatDonationBeforeRegistrationTreeAmountPipe.ɵpipe = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefinePipe"]({
      name: "formatDonationBeforeRegistrationTreeAmount",
      type: FormatDonationBeforeRegistrationTreeAmountPipe,
      pure: true
    });
    /*@__PURE__*/

    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](FormatDonationBeforeRegistrationTreeAmountPipe, [{
